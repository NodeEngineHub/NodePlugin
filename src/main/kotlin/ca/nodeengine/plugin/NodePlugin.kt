...
class NodePlugin : Plugin<Project> {
    ...
    override fun apply(target: Project) {
        ...
        target.subprojects.forEach { project ->
            includeProject(target, rootExtension, project)
        }
    ...
    private fun includeProject(root: Project, rootExtension: NodePluginExtension, project: Project) {
        ...
        project.afterEvaluate {
            ...
            if (extension.includeLombok.get() && root.providers.gradleProperty("lombokVersion").isPresent) {
                val lombokVersion: String = root.providers.gradleProperty("lombokVersion").get()
            ...
            val errorproneVersion: String = root.providers.gradleProperty("errorproneVersion").get()
            val nullawayVersion: String = root.providers.gradleProperty("nullawayVersion").get()
